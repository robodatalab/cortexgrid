...
Base: `python:3.11-slim`. Installs `mlflow==3.11.1`, `psycopg2-binary==2.9.9`, `boto3==1.34.29`. Runs `mlflow server` on port 5000. Used by the MLflow deployment ([../argo_deployments/mlflow/](../../../k8s/argo_deployments/aws/mlflow/)).
