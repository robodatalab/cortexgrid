...
**stack.yaml** — Argo Application pointing at raw k8s manifests at [`k8s/workloads/jobs-control-plane/`](../../../../k8s/workloads/jobs-control-plane/). Deployed into the `jobs-control-plane` namespace. Sync-wave `2` so MLflow and Ray install first. See [workloads/jobs-control-plane/README.md](../../workloads/jobs-control-plane/README.md) for the k8s spec itself.
