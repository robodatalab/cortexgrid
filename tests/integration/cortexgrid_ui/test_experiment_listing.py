...
class TestExperimentListing(UITestCase):
    def test_experiment_appears_then_disappears_after_delete(self) -> None:
        ...
        cortexgrid.delete_experiment(name)
    ...
    def test_independent_creates_and_deletes_visible_to_both_users(self) -> None:
        ...
        self.addCleanup(cortexgrid.delete_experiment, exp1)
        self.addCleanup(cortexgrid.delete_experiment, exp2)
        ...
        cortexgrid.Experiment.init(exp1)
        cortexgrid.Experiment.close()
        cortexgrid.Experiment.init(exp2)
        ...
        cortexgrid.delete_experiment(exp1)
